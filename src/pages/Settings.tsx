...
const Settings = () => {
  ...
  const { changePassword, logout } = useLoginStore();
      ...
      <div className="p-7">
        <form action="#">
          ...
          <div className="flex justify-end gap-4.5">
            <button
              className="flex justify-center rounded border border-stroke py-1.5 px-6 font-medium text-black hover:shadow-1 dark:border-strokedark dark:text-white"
              type="submit"
            >
              Cancel
            </button>
            <button
              className="flex justify-center rounded bg-primary py-1.5 px-6 font-medium text-gray hover:shadow-1"
              type="submit"
              onClick={fireToast}
            >
              Save
      ...
      <div className="p-7">
        <form action="#">
          ...
          <div className="flex justify-end gap-4.5">
            ...
            <button
              className="flex justify-center rounded bg-primary py-1.5 px-6 font-medium text-gray hover:bg-opacity-70"
              type="submit"
            >
              Save
            </button>
